...
#pragma acc host_data use_device(&ex[src], &ey[src], &hz[src], &ex_global[dst], &ey_global[dst], &hz_global[dst])
        {
...
#pragma acc update host(ex_global[0:nelems_global], ey_global[0:nelems_global], hz_global[0:nelems_global])
...
#pragma acc host_data use_device(&hz[src_hz], &hz[dst_hz])
        {
...
#pragma acc host_data use_device(&ex[src_ex], &ex[dst_ex])
        {
